...
export default function Terms() {
  ...
  const h1 = {
    ...
    color: "#2f2f2f",
    margin: "0 0 10px",
    scrollMarginTop: "calc(var(--header-h, 72px) + 16px)",
  };
  ...
  // Sections are link targets; add scroll offset for fixed header
  const cardSection = {
    ...cardBase,
    scrollMarginTop: "calc(var(--header-h, 72px) + 16px)",
  };
  ...
  return (
    <div style={wrap}>
      ...
      <div style={{ display: "grid", gap: 18, marginTop: 18 }}>
        <section id="eligibility" style={cardSection}>
        ...
        <section id="orders" style={cardSection}>
        ...
        <section id="pricing" style={cardSection}>
        ...
        <section id="pickup" style={cardSection}>
        ...
        <section id="cancellations" style={cardSection}>
        ...
        <section id="custom" style={cardSection}>
        ...
        <section id="giftcards" style={cardSection}>
        ...
        <section id="ip" style={cardSection}>
        ...
        <section id="conduct" style={cardSection}>
        ...
        <section id="links" style={cardSection}>
        ...
        <section id="warranty" style={cardSection}>
        ...
        <section id="liability" style={cardSection}>
        ...
        <section id="indemnity" style={cardSection}>
        ...
        <section id="law" style={cardSection}>
        ...
        <section id="changes" style={cardSection}>
        ...
        <section id="contact" style={cardSection}>
