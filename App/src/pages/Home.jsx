    ...
    <section className="home-hero">
      ...
      <div className="home-container home-heroInner">
        <div className="home-heroContent">
          ...
          <a href="/e-boutique" className="home-cta">BROWSE MENU</a>
        </div>
      </div>
    </section>
  );
...
function PastriesSection() {
  const cards = [
    { title: "Cakes", img: cakesImg, to: "/cakes" },
    { title: "Personal Desserts", img: personalDessertsImg, to: "/personal-desserts" },
    { title: "One-Bite Assortments", img: oneBiteImg, to: "/onebite" },
  ];
        ...
        <div className="home-grid3">
          {cards.map((c) => (
            <Link
              key={c.title}
              to={c.to}
              className="home-card"            // the Link IS the card
              onMouseEnter={(e) => {
    ...
    <section className="home-giftSection">
      <div className="home-giftGrid">
        ...
        <div className="home-giftTextCol">
          ...
          <a href="/personal-desserts" className="home-giftBtn">
            SEE OUR GIFT BOXES
          </a>
        </div>
      </div>
