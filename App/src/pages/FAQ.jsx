...
export default function FAQ() {
  ...
  const pageTop = { paddingTop: "24px" }; // ✅ extra space under fixed header
  ...
  const h1 = {
    ...
    color: "#2f2f2f",
    margin: "0 0 10px",
    // ✅ if you link to #FAQs, it will scroll below the fixed header
  ...
  const grouped = useMemo(
    () => (query.trim() ? [{ id: "results", title: "Results", faqs: filtered }] : sections),
  ...
  return (
    <>
      ...
      <div style={{ ...wrap, ...pageTop }}>
        ...
        {/* Sections */}
        <div className="faq__grid" style={grid}>
          {grouped.map((sec) => (
