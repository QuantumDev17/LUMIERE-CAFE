      ...
      <div style={styles.headerBar}>
        ...
        <div style={styles.navWrap}>
          <nav style={styles.nav}>
            <Link to="/pages/e-boutique" style={styles.navLink}>E-Boutique</Link>
            <Link to="/pages/about" style={styles.navLink}>Our Story</Link>
            <Link to="/pages/contact" style={styles.navLink}>Contact</Link>
            <Link to="/products/lumiere-gift-card" style={styles.navLink}>Lumière Gift Card</Link>
          </nav>
        </div>
